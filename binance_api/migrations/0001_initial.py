        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Nombre del activo.", max_length=20, null=True
                    ),
                ),
                (
                    "description",
                ...
                (
                    "deposit_status",
                    models.BooleanField(help_text="Estado de depósito.", null=True),
                ),
                (
                    "withdraw_fee",
                    models.DecimalField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_trade_id",
                    models.IntegerField(
                        blank=True, help_text="ID de la primera operación", null=True
                    ),
                ),
                (
                    "last_trade_id",
                    models.IntegerField(
                        blank=True, help_text="ID de la última operación", null=True
                    ),
                ),
                (
                    "trade_count",
                    models.IntegerField(
                        blank=True, help_text="Número de operaciones", null=True
                    ),
                ),
                (
                    "maker_commission",
